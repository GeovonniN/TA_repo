...
class className:
    ...
    def check_attempt(self, params):
        ...
        try:
                ...
                if len(hint) > 0:
                        return hint + 'What is the number of strings of length 3 with an alphabet of {a,b,c,d,e}?','5^3'
                else:
                        return '',''
        except Exception:
                return '',''
    ...
    def get_problems(self):
        self.problem_list = ["Combinatorics/p13/part2"]
